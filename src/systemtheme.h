// Adapted from Omawrite (https://github.com/omacom-io/omawrite), MIT License,
// Copyright (c) 2026 David Heinemeier Hansson. Reads dark mode and text scale
// from the xdg-desktop-portal so barq follows the desktop like a native app.
